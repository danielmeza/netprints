...
| Tag | Location |
|---|---|
| `BL/…` | `tests/NetPrints.Editor.UITests/Snapshots/Baselines/*.png` (all 17 viewed) |
...
| code | `src/NetPrints.Editor/**` and `git show master:NetPrintsEditor/**` |
