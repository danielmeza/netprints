...
public partial class GraphEditorView : UserControl
{
    ...
    public GraphEditorView()
    {
        ...
        {
            Geometry = new RectangleGeometry(new Rect(0, 0, EditorConstants.GridCellSize, EditorConstants.GridCellSize)),
            Pen = new Pen(Brushes.Gray, 0.5),
        })
        {
            TileMode = TileMode.Tile,
            DestinationRect = new RelativeRect(0, 0, EditorConstants.GridCellSize, EditorConstants.GridCellSize, RelativeUnit.Absolute),
        };
